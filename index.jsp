...
//106.10.18 fix 恢復動態顯示公告 by 2295
	...
	<tr colspan="0" bordercolor="#63B1AE" bgcolor="#408C87"><img src="images/hotnews.gif" width="70" height="18"></tr>	
           ...
           <%
            ...
            for(int i=0;i<WLX_Notify.size();i++){
                ...
                if(headmark.indexOf("異常") != -1 || headmark.indexOf("設定") != -1 || headmark.indexOf("停止") != -1 || headmark.indexOf("暫停") != -1){
                   fontColor="yellow";//關鍵字有異常.設定.停止.暫停時,以黃色顯示 109.02.27 fix
        ...
        <tr> 
          ...
          <td rowspan="2" valign="top" bgcolor="#78B5B3">
			<table width="250" border="0" align="center" cellpadding="0" cellspacing="1" class="sbody">
              ...
              <tr>
               <td colspan="2">
                <img id="codeImg" src="randomcode.jpg" /></td>              		
              </tr>            
              <tr> 
                <td width="65">更改密碼 :</td>
