...
function doSubmit(form,cnd){	     	  
	...
	if( confirm("確定回清單頁？")){
		form.action="/pages/TM006W.jsp?act=Qry";	    
		form.submit();
		}
	}
...
function checkData(form) {
	...
	for(var i=0; i<document.getElementsByName("acc_Code01").length; i++){
		...
		if(document.getElementsByName("apply_Cnt_Sum01")[i].value=="")document.getElementsByName("apply_Cnt_Sum01")[i].value="0";
		if(document.getElementsByName("apply_Amt_Sum01")[i].value=="")document.getElementsByName("apply_Amt_Sum01")[i].value="0";
		if(document.getElementsByName("apply_Bal_Sum01")[i].value=="")document.getElementsByName("apply_Bal_Sum01")[i].value="0";
		...
		if(document.getElementsByName("appr_Cnt_Sum01")[i].value=="")document.getElementsByName("appr_Cnt_Sum01")[i].value="0";
		if(document.getElementsByName("appr_Amt_Sum01")[i].value=="")document.getElementsByName("appr_Amt_Sum01")[i].value="0";
		if(document.getElementsByName("appr_Bal_Sum01")[i].value=="")document.getElementsByName("appr_Bal_Sum01")[i].value="0";
		...
		tmpStr = tmpStr 
		            ...
		            +","+(parseInt(document.getElementsByName("apply_Cnt_Sum01")[i].value)+parseInt(document.getElementsByName("apply_Cnt01")[i].value))
		            +","+(parseInt(document.getElementsByName("apply_Amt_Sum01")[i].value)+parseInt(document.getElementsByName("apply_Amt01")[i].value))
		            +","+(parseInt(document.getElementsByName("apply_Bal_Sum01")[i].value)+parseInt(document.getElementsByName("apply_Bal01")[i].value))
		            ...
		            +","+(parseInt(document.getElementsByName("appr_Cnt_Sum01")[i].value)+parseInt(document.getElementsByName("appr_Cnt01")[i].value))
		            +","+(parseInt(document.getElementsByName("appr_Amt_Sum01")[i].value)+parseInt(document.getElementsByName("appr_Amt01")[i].value))
		            +","+(parseInt(document.getElementsByName("appr_Bal_Sum01")[i].value)+parseInt(document.getElementsByName("appr_Bal01")[i].value))
	...
	for(var i=0; i<document.getElementsByName("acc_Code02").length; i++){
		...
		if(document.getElementsByName("apply_Cnt_Sum02")[i].value=="")document.getElementsByName("apply_Cnt_Sum02")[i].value="0";
		if(document.getElementsByName("apply_Amt_Sum02")[i].value=="")document.getElementsByName("apply_Amt_Sum02")[i].value="0";
		if(document.getElementsByName("apply_Bal_Sum02")[i].value=="")document.getElementsByName("apply_Bal_Sum02")[i].value="0";
		...
		if(document.getElementsByName("appr_Cnt_Sum02")[i].value=="")document.getElementsByName("appr_Cnt_Sum02")[i].value="0";
		if(document.getElementsByName("appr_Amt_Sum02")[i].value=="")document.getElementsByName("appr_Amt_Sum02")[i].value="0";
		if(document.getElementsByName("appr_Bal_Sum02")[i].value=="")document.getElementsByName("appr_Bal_Sum02")[i].value="0";
		...
		tmpStr = tmpStr 
		            ...
		            +","+(parseInt(document.getElementsByName("apply_Cnt_Sum02")[i].value)+parseInt(document.getElementsByName("apply_Cnt02")[i].value))
		            +","+(parseInt(document.getElementsByName("apply_Amt_Sum02")[i].value)+parseInt(document.getElementsByName("apply_Amt02")[i].value))
		            +","+(parseInt(document.getElementsByName("apply_Bal_Sum02")[i].value)+parseInt(document.getElementsByName("apply_Bal02")[i].value))
		            ...
		            +","+(parseInt(document.getElementsByName("appr_Cnt_Sum02")[i].value)+parseInt(document.getElementsByName("appr_Cnt02")[i].value))
		            +","+(parseInt(document.getElementsByName("appr_Amt_Sum02")[i].value)+parseInt(document.getElementsByName("appr_Amt02")[i].value))
		            +","+(parseInt(document.getElementsByName("appr_Bal_Sum02")[i].value)+parseInt(document.getElementsByName("appr_Bal02")[i].value))
