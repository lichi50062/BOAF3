...
var ppcIE=true;//((navigator.appName == "Microsoft Internet Explorer") || ((navigator.appName == "Netscape") && (parseInt(navigator.appVersion)==5)));//111.04.15 fix
var ppcNN6=false;//((navigator.appName == "Netscape") && (parseInt(navigator.appVersion)==5)); //111.04.15 fix
...
function showCalendar(frmName, dteBox,btnImg, hideDrops, MnDt, MnMo, MnYr, MxDt, MxMo, MxYr,runFuncs) {
	alert('showCalendar='+frmName+'+IsCalendarVisible='+IsCalendarVisible);//111.04.12
