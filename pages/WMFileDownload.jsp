...
//110.04.26 fix 調整報表設定資料取得使用char array by 2295
%>
...
<%
	...
	char[] rptPwd = (Utility.getProperties("rptPwd")).toCharArray();
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
    	...
    	if(act.equals("new")){
    	    ...
    	    //============add by 2354 12.22 begin ---
    	    	...
    	    	request.setAttribute("data_div01",data_div01);
    	    	request.setAttribute("data_div02",data_div02);	
    	    }else if(Report_no.equals("A15")){//104.10.12 add by 2295
    	    	data_div01=getData_A01_A05(S_YEAR,S_MONTH,bank_code,bank_type,"15");
    	    	request.setAttribute("data_div01",data_div01);
        	        ...
        	        if(actMsg.equals("")){
    			    	...
    			    	if(data.size() != 0){
    			    		...
    			    		System.out.println("filename="+filename);
    	            	  	...
    	            	  	MyFTPClient ftpC = new MyFTPClient(rptIP, rptID, String.valueOf(rptPwd));
...
<%!
    ...
    private List getData_A01_A05(String S_YEAR,String S_MONTH,String bank_code,String bank_type,String acc_div){
    		...
    		if(bank_type.equals("6") || (bank_type.equals("7") && !acc_div.equals("01") && !acc_div.equals("02") && !acc_div.equals("05") && !acc_div.equals("08") && !acc_div.equals("99") && !acc_div.equals("12")  && !acc_div.equals("13"))){
    		   ...
    		   else if(acc_div.equals("15"))					Report_NO="A15";//109.08.06 add by 6493
    		   ...
    		   if(Report_NO.equals("A05")){
                  ...
                  if(bank_type.equals("7") && (Report_NO.equals("A01") || Report_NO.equals("A03") || Report_NO.equals("A06") || Report_NO.equals("A99")) ){
    		   ...
    		   if (Report_NO.equals("A02") || Report_NO.equals("A99")) {//95.05.17 add A02漁會以ncacno_7為主//95.05.18 add A99漁會以ncacno_7為主
