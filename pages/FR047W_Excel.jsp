...
<%
   ...
   String printStyle = ( request.getParameter("printStyle")==null ) ? "" : (String)request.getParameter("printStyle");//108.05.09
   
   String filename="應予評估資產彙總表.xls";
  
   System.out.println("FR047W_Excel.S_YEAR="+S_YEAR+":act="+act);
