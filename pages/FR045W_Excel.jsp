...
<%
   ...
   System.out.println("FR045W.S_YEAR="+S_YEAR+":S_MONTH="+S_MONTH+":E_YEAR="+E_YEAR+":E_MONTH="+E_MONTH+":act="+act+":bank_type="+bank_type+":BankList="+BankList+":printStyle="+printStyle); 
