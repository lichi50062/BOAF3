    		...
    		for(int i=0;i<checkFile.size();i++){	        			    
    			...
    			try{    					
    				...
    				if(Report_no.equals("A01")){
    					...
    					actMsg = UpdateA15.doParserReport_A15(Report_no,String.valueOf(Integer.parseInt(S_YEAR)),String.valueOf(Integer.parseInt(S_MONTH)),((String)checkFile.get(i)),bank_code,"M","F",bank_type,"","",batch_no);    						    				    						         					    			    					
