...
//111.03.03 調整Edge在非a href無法識別forms/調整xml取得方式 by 2295
%>
...
<%	//--------------------取得資料------------------------
    ...
    if((WLX08_R_Data!=null) && WLX08_R_Data.size() > 0){
        ...
        DataObject temp_bean =(DataObject)WLX08_R_Data.get(0);
       	out.print("<flag>Y</flag>");
        out.print("<docno>"+temp_bean.getValue("applyok_docno")+"</docno>");
        out.print("<boafdocno>"+temp_bean.getValue("report_boaf_docno")+"</boafdocno>");
		...
		out.print("<apoky>"+temp_year+"</apoky>");
		out.print("<apokm>"+temp_month+"</apokm>");
		out.print("<apokd>"+temp_day+"</apokd>"); 
		...
		out.print("<boafy>"+temp_year+"</boafy>");
		out.print("<boafm>"+temp_month+"</boafm>");
		out.print("<boafd>"+temp_day+"</boafd>"); 
    }   
    out.print("</data>");
    out.println("</datalist>\n</xml>");
        ...
        <table class="sbody"  border="1" cellspacing="1" bordercolor="#3A9D99"  bordercolor="#3A9D99" width="599" height="346">
			...
			<tr>
				...
				<td width='385' bgcolor='e7e7e7' >
	            	...
	            	<font color='red' size=4>*</font><input type="button" name="Check_Borrowe_Summary" value="機構名稱(借款人)申辦之歷史明細" onClick="javascript:doSubmit(document.UpdateForm,'load','');">
	            </td>
			</tr>
			...
			<tr>
				...
				<td width='380' bgcolor='e7e7e7'>
		            ...
		            <font color='red' size=4>*</font>    
                    <!-- 按了之後 抄錄上面的申請延長日期 -->
                    <input type="button" name="Load_Upper_Dure" value="同申請延長日期" onClick="javascript:loadUpperDate(document.UpdateForm);">             
				</td>
			</tr>
			...
			<tr>
				...
				<td width='380' bgcolor='#e7e7e7'>
		            ...
		            <font color='red' size=4>*&nbsp;</font> 
                    <!-- 按了之後 試算出延長之後之日期 --> 
                    <!--98.01.07 fix 不試算核准申請延長期限(A)+(B)input type="button" name="calculus" value="試算" onClick="javascript:calculusDate(document.UpdateForm);"-->        
				</td>
			</tr>
			...
			<tr>
				<td width="600" bgcolor='#D8EFEE' colspan="4" align= 'Center' >
					<!-- 按了之後 抄錄最近一筆異動 -->
					<input type="button" name="Load_change_Data" value="抄錄本年本季最近一筆文號及日期" onClick="javascript:LoadRecentData(document.UpdateForm,'Rpt_BOAF');">    
