 ...
 *111.03.21 調整Edge未顯示挑選有無分項,及輸入有幾個分項 by 2295
 */
%>
...
<!-- -----------------------------hide type---------------------------- -->
 			...
 			<br>
 			<center><input type="button" name="button" value="確定" onclick="javascript:doSubmit(document.UpdateForm,'nextPg','<%=bank_no%>','<%=A11_Lock%>','<%=isLastMonthData%>','<%=isHaveApplyData%>','<%=isHaveNoApplyData%>','<%=isHaveNoApplyLoanData%>');"></center>
 			<br>
 		</td>
        </tr>
    </table>
