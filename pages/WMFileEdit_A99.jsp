...
//111.07.13 add 992711/992712/992713 by 2295
%>
...
%>
		    ...
		    <%if(!(tmpAcc_Code.equals("992410") || tmpAcc_Code.equals("992420") || tmpAcc_Code.equals("992440")
                 ...
                 ||tmpAcc_Code.equals("992710") || tmpAcc_Code.equals("992711") || tmpAcc_Code.equals("992712") || tmpAcc_Code.equals("992713") || tmpAcc_Code.equals("992720") || tmpAcc_Code.equals("992730")
			...
			<td rowspan="6" width="19" height="80">
			<div align=left>		
            <p align="center">建築放款				
			</div>
			</td>			
			...
			<%=(String)((DataObject)data_div01.get(i)).getValue("acc_name")%>									
			<%}//end of 992610%>	
			<%if(tmpAcc_Code.equals("992440") || tmpAcc_Code.equals("992520") || tmpAcc_Code.equals("992620") || tmpAcc_Code.equals("992720") || tmpAcc_Code.equals("992711") || tmpAcc_Code.equals("992712") || tmpAcc_Code.equals("992713") ){%>
