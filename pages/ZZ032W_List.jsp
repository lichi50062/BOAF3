...
<%
	...
	System.out.println("test1.YEAR="+now.get(Calendar.YEAR));
	System.out.println("test1.MONTH="+now.get(Calendar.MONTH));
   	...
   	System.out.println("test2.YEAR="+YEAR);
	System.out.println("test2.MONTH="+MONTH);
    ...
    System.out.println("test3.YEAR="+YEAR);
	System.out.println("test3.MONTH="+MONTH);
	System.out.println("S_YEAR="+request.getParameter("S_YEAR"));
	System.out.println("S_MONTH="+request.getParameter("S_MONTH"));
	...
	String S_YEAR = (( request.getParameter("S_YEAR")==null || "".equals((String)request.getParameter("S_YEAR")))) ? YEAR : (String)request.getParameter("S_YEAR");				
	String S_MONTH = (( request.getParameter("S_MONTH")==null || "".equals((String)request.getParameter("S_MONTH")))) ? MONTH : (String)request.getParameter("S_MONTH");				
