...
//111.02.09 調整挑選裁撤/遷移時,無法輸入裁撤/遷移日期 by 2295
%>
...
function Enable()
{
	if(UpdateForm.cancel_type.value!=""){
		UpdateForm.CANCEL_DATE_Y.disabled=false;
		UpdateForm.CANCEL_DATE_M.disabled=false;
		UpdateForm.CANCEL_DATE_D.disabled=false;
	}
	else
	{
		UpdateForm.CANCEL_DATE_Y.value="";
		UpdateForm.CANCEL_DATE_M.value="";
		UpdateForm.CANCEL_DATE_D.value="";
		UpdateForm.CANCEL_DATE_Y.disabled=true;
		UpdateForm.CANCEL_DATE_M.disabled=true;
		UpdateForm.CANCEL_DATE_D.disabled=true;
	}
}
//-->
</script>
                     ...
                     <%
                           ...
                           <% if(WLX05_ATM_SETUP==null)
                            ...
                            <td width="411" bgColor="#e7e7e7" height="40">
                             <select name='cancel_type' onChange='Enable()'>
                               <option></option>
