...
//106.03.08 add A02法定比率資料報表下載說明文字-->107.08.23 取消顯示 by 2295
//108.03.28 add 報表格式挑選 by 2295		
//110.08.06 add A11不提供申報資料查詢下載 by 2295
...
<body marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" leftmargin="0" onload="javascript:hiddenDownload('hidden');">
                    ...
                    <tr>
                      <td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">
                        ...
                        <tr class="sbody">
						  ...
						  <td colspan=2 bgcolor='e7e7e7'><select name=Report_no  onchange="javascript:hiddenDownload('hidden');">
							<%
							for (i = 0; i < Report_List.length; i++) {
								if(Report_List[i][0].equals("A11")) continue; //110.08.06 A11不提供申報資料查詢下載									
							%>
                        ...
                        <tr class="sbody">
							<td align='left' bgcolor='#D8EFEE'>輸出格式</td>
							<td colspan=2 bgcolor='e7e7e7'>
							   <div id="rptStype_ods" style="POSITION:relative;display:block;width:100%;">
                               ...
                               <div id="rptStype_odt" style="POSITION:relative;display:block;width:100%;">   
