...
<table width="321" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
      ...
      <tr>
          <td bgcolor="#FFFFFF" width="618">
                ...
                <table width="734" border="0" align="center" cellpadding="0" cellspacing="0" height="8">
            		...
            		<tr class="sbody">
            			...
            			<td width='491' bgcolor='e7e7e7' height="28">
                    		...
                    		<input type="button" name="load" value="載入上月申報資料" onClick="javascript:doSubmit('load','','','','');">              
                    		</p>
                    		<%}%>
                    		</font>
                    	</td>
            ...
            onBlur='checkTotal_house(<%=ini_credityear_cnt_acc%>,<%=flag_house%>);this.value=changeStr(this);' style='text-align: right;'  >
            </td>
	    </tr>
            <tr class="sbody">
            ...
            <td width='491' bgcolor='e7e7e7' height="15">
             ...
             onBlur='checkTotal_cash(<%=ini_credityear_amt_acc%>,<%=flag_cash%>);this.value=changeStr(this);' style='text-align: right;'>
             <font face="標楷體">                
  ...
  <tr>
                <td width="734" height="123"><table width="734" border="0" cellpadding="1" cellspacing="1" class="sbody" height="176">
                    ...
                    <table width="243" border="0" cellpadding="1" cellspacing="1">
                      ...
                      %>
                <td width="66"><div align="center"><a href="javascript:doSubmit('add',<%=ini_credityear_cnt_acc%>,<%=ini_credityear_amt_acc%>,<%=flag_house%>,<%=flag_cash%>);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image101','','images/bt_confirmb.gif',1)"><img src="images/bt_confirm.gif" name="Image101" width="66" height="25" border="0" id="Image101"></a></div></td>
                <% } }else{

                if(permission != null && permission.get("U") != null && permission.get("U").equals("Y")){//Update %>
                <td width="66"><div align="center"><a href="javascript:doSubmit('modify','','','','');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image103','','images/bt_updateb.gif',1)"><img src="images/bt_update.gif" name="Image103" width="66" height="25" border="0" id="Image103"></a></div></td>
                <td width="66"><div align="center"><a href="javascript:doSubmit('delete','','','','');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image104','','images/bt_deleteb.gif',1)"><img src="images/bt_delete.gif" name="Image104" width="66" height="25" border="0" id="Image104"></a></div></td>
              <% }}%>
                        ...
                        <td width="93"><div align="center"><a href="javascript:doSubmit('returnList','','','','');"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image106','','images/bt_05b.gif',1)"><img src="images/bt_05.gif" name="Image106" width="80" height="25" border="0" id="Image106"></a></div></td>
                      </tr>
                    </table>
                  </div>
                     </td>
