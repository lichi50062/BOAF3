...
//109.06.12 add A15 by 2295
//110.08.18 add 992451/992453/992455/992461/992463/992465顯示amt_name by 2295[111.06.13取消]
%>
...
<%
		...
		//============modify by 2354 12.22 begin ---
 	    if(Report_no.equals("A01") || Report_no.equals("A02") || Report_no.equals("A03") || Report_no.equals("A04") || Report_no.equals("A05") || Report_no.equals("A06") || Report_no.equals("A99") || Report_no.equals("A08") || Report_no.equals("A09") || Report_no.equals("A10")|| Report_no.equals("A12") || Report_no.equals("A13") || Report_no.equals("A15")){
 	    	List data = null; 	    	
 	    	if(Report_no.equals("A08")){
 	    	   ...
 	    	   data = DBManager.QueryDB_SQLParam(sqlCmd.toString(),paramList,"m_year,m_month,amt,amt_3month,amt_6month,amt_1year,amt_2year,amt_over2year,amt_total,month_amt,year_amt");
    		}
			...
			//===============================================
 	    	...
 	    	if(data.size() != 0){
 	    	      while(i < data.size()){
				   	   ...
				   	   if(Report_no.equals("A08")){//96.07.11 add A08
				           ...
				           //over_cnt,over_amt,push_over_amt,totalamt,push_totalamt,over_total_rate
				   	   ...
				   	   }else if(Report_no.equals("A15")){//109.06.12 add A15
  				   	   	   out.print((String)((DataObject)data.get(i)).getValue("acc_code"));
				   		   //month_amt,year_amt
				   		   out.print(DownLoad.fillStuff((((DataObject)data.get(i)).getValue("month_amt")).toString(), "L", "0", 0, 14));
				   	       out.print(DownLoad.fillStuff((((DataObject)data.get(i)).getValue("year_amt")).toString(), "L", "0", 0, 14));
				       }else{
				   	       out.print((String)((DataObject)data.get(i)).getValue("acc_code"));
				   	       ...
				   	       if( !tmpAcc_Code.substring(tmpAcc_Code.length()-1).equals("N")){
				   	          ...
				   	          //110.08.18 add 992451/992453/992455/992461/992463/992465顯示amt_name[111.06.13取消]    
				   	          /*
				   	          }else if( tmpAcc_Code.equals("992451") || tmpAcc_Code.equals("992453") || tmpAcc_Code.equals("992455")   
				   	                ||  tmpAcc_Code.equals("992461") || tmpAcc_Code.equals("992463") || tmpAcc_Code.equals("992465")){
								 out.print(DownLoad.fillStuff((String)((DataObject)data.get(i)).getValue("amt_name"), "R", " ", 160));
							  */	 
				   	          }else{
