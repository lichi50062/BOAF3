...
<%
	...
	if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
	    ...
	    System.out.println("test1090515");
    	if(act.equals("List") || act.equals("Qry") || act.equals("Edit") ||  act.equals("New") || act.equals("Qry2")) {
    	    ...
    	    if(act.equals("List")) {
    	        ...
    	        if(act.equals("New")) {
    	            ...
    	            reportno_seq = request.getParameter("reportno_seq") != null ? request.getParameter("reportno_seq") : "";
    	            System.out.println("1040603--test11");
    	            request.setAttribute("DETAIL",getDetail(reportno,reportno_seq));
    	             System.out.println("1040603--test22");
    	        ...
    	        request.setAttribute("HEAD",getQueryList(reportno,begY));
        	...
        	System.out.println("test1090515-2");
            ...
            String item_no = request.getParameter("item_no" )== null  ? "" : (String)request.getParameter("item_no");
             String reportno_seq = request.getParameter("reportno_seq" )== null  ? "" : (String)request.getParameter("reportno_seq");
            actMsg = Utility.insertDataToLog(request, userId, pgId);
            request.setAttribute("prePageURL","TC33.jsp?act=Edit&reportno="+reportno+"&item_no="+item_no+"&reportno_seq="+reportno_seq);
        	rd = application.getRequestDispatcher( nextPgName );
        } else if(act.equals("Delete")){
        	System.out.println("test1090515-3");
            actMsg = Utility.insertDataToLog(request, userId, pgId);
...
private List getBankNo(){
    ...
    private List getExFaultdaData() {
        String sqlCmd = " SELECT faultda_id, faultda_name FROM exfault_daf order by faultda_id ";
        List dbData = DBManager.QueryDB_SQLParam(sqlCmd,null,"");
        return dbData;
    }
