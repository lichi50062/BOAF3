   ...
   //Insert  data ==================================================
        ...
        if("EditNextCnt".equals(actMsg)){
            String m_year		=((String)request.getParameter("hyear")==null)?"":(String)request.getParameter("hyear");
      		...
      		String case_cnt     =((String)request.getParameter("case_cnt")==null)?"":(String)request.getParameter("case_cnt");//111.02.11 add
 	    	rd = application.getRequestDispatcher( "/pages/WMFileEdit_A11_EditNextCnt.jsp?act=New&s_year="+m_year+"&s_month="+m_month+"&bank_no="+bank_no+"&case_no="+case_no+"&case_cnt="+case_cnt ); 
        }else{
