...
//111.10.06 fix 調整Chrome/Edit無法刪除/更新附檔 by 2295
%>
...
<table width="640" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
		  ...
		  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr class="sbody">
						...
						<%if(!pre_append_file.equals(" ")){%> 								
                            <p>                           
                              <%=pre_append_file%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="ResetLoad" value="刪除"  onClick="javascript:doSubmit(document.form,'Clear','<%=seq_no%>');">&nbsp;&nbsp;&nbsp;<input type="submit" name="ResetLoad" value="開啟檔案"  onClick="javascript:doSubmit(document.form,'Open','<%=seq_no%>');">
                              </font><font color='#000000'>                                                                                         
                              </font></p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              </font></p>
            <%}%>
            </td>           
