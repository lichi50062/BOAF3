...
<%
   ...
   System.out.println("FR083W_Excel.act="+act+":bank_type="+bank_type+":bank_code="+bank_code+":S_YEAR="+S_YEAR+":S_MONTH="+S_MONTH);
	    	...
	    	if(act.equals("Qry")){
   			...
   			*/
   			...
   			if(act.equals("view") || act.equals("download")){
   				try{
	    			actMsg =RptFR083W.createRpt(S_YEAR,S_MONTH,"1000",bank_code,bank_name,bank_type);
...
<%!
    ...
    private final static String RptCreatePgName = "/pages/FR083W_Excel.jsp";
