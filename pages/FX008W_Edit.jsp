...
//111.03.03 調整Edge機構名稱(借款人)申辦之歷史明細無反應 by 2295
%>
...
<!-- -----------------------------end of hide type---------------------------- -->
        		...
        		onClick="javascript:doSubmit(document.UpdateForm,'No_Apply','123');">
        ...
        <tr>
			...
			<td width='398' bgcolor='e7e7e7' >
              	<input type='text' name='debtname'
               	...
               	<font color='red' size=4>*</font><font color='red' size=4>*</font><input type="button" name="Check_Borrowe_Summary" value="機構名稱(借款人)申辦之歷史明細" onClick="javascript:doSubmit(document.UpdateForm,'load_history','');">
			</td>
		</tr>
