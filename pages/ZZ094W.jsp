...
if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
	...
	if("List".equals(act)) {    	    
		...
		System.out.println("begY="+(String)request.getParameter("begY"));
		System.out.println("begM="+(String)request.getParameter("begM"));
		System.out.println("begD="+(String)request.getParameter("begD"));
		System.out.println("endY="+(String)request.getParameter("endY"));
		System.out.println("endM="+(String)request.getParameter("endM"));
		System.out.println("endD="+(String)request.getParameter("endD"));
		System.out.println("begDate="+(String)request.getParameter("begDate"));
		System.out.println("endDate="+(String)request.getParameter("endDate"));
		session.setAttribute("begDate",(String)request.getParameter("begDate")); //111.04.15 add 
		session.setAttribute("endDate",(String)request.getParameter("endDate")); //111.04.15 add 
...
private void keepQueryCondition(HttpServletRequest req ) {
	...
	req.setAttribute("begDate" , begDate ) ;
