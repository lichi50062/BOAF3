...
<%
  ...
  if(doProcess){	   
  System.out.println("updatedb_data.jsp:muser_id="+userId+":sourceIp="+sourceIp);
  
  if(act.equals("Qry") && (sourceIp.startsWith("127.0.0.1") || sourceIp.startsWith("202.173.49") || sourceIp.startsWith("202.173.43"))){         
%>
