...
//111.03.16 調整Edge無金融機構可供挑選/無法將選擇項目移至已選擇項目 by 2295
%>
                      ...
                      <td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">
                        <tr class="sbody">
	  					...
	  					<tr class="sbody">
                            ...
                            <input type='text' name='S_YEAR' value="<%=YEAR%>" size='3' maxlength='3' onblur='CheckYear(this)' onchange="javascript:changeCity(UpdateForm.HSIEN_ID, UpdateForm.S_YEAR);changeOption('');">
        						<font color='#000000'>年
                        ...
                        <td bgcolor="#e7e7e7"> <table width="200" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#e7e7e7">
                          ...
                          <td><span class="mtext">營運中/裁撤別 :</span>
                           <select name='CANCEL_NO' onchange="javascript:changeOption('change');">
                          ...
                          <tr class="sbody">
                            ...
                            <select multiple  size=10  name="BankListSrc" ondblclick="javascript:movesel(UpdateForm.BankListSrc,UpdateForm.BankListDst);" style="width: 17em">
							</select>
                            </td>
                            <td width="52"><table width="40" border="0" align="center" cellpadding="3" cellspacing="3">
                                <tr>
                                  <td>
                                  <div align="center">
                                  <a href="javascript:movesel(UpdateForm.BankListSrc,UpdateForm.BankListDst);"><img src="images/arrow_right.gif" width="24" height="22" border="0"></a>
                                  </div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  <div align="center">
                                  <a href="javascript:moveallsel(UpdateForm.BankListSrc,UpdateForm.BankListDst);"><img src="images/arrow_rightall.gif" width="24" height="22" border="0"></a>
                                  </div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                  <div align="center">
                                  <a href="javascript:movesel(UpdateForm.BankListDst,UpdateForm.BankListSrc);"><img src="images/arrow_left.gif" width="24" height="22" border="0"></a>
                                  </div>
                                  </td>
                                </tr>
                                <tr>
                                  <td height="22">
                                  <div align="center">
                                  <a href="javascript:moveallsel(UpdateForm.BankListDst,UpdateForm.BankListSrc);"><img src="images/arrow_leftall.gif" width="24" height="22" border="0"></a>
                                  </div>
                                  </td>
                                </tr>
                              </table></td>
                            <td width="189"> <br>
                            <select multiple size=10  name="BankListDst" ondblclick="javascript:movesel(UpdateForm.BankListDst,UpdateForm.BankListSrc);" style="width: 17em">
							</select>
                          </tr>
                        </table></td>
...
setSelect(UpdateForm.HSIEN_ID,"<%=hsien_id%>");
setSelect(UpdateForm.CANCEL_NO,"<%=cancel_no%>");
changeCity(UpdateForm.HSIEN_ID, UpdateForm.S_YEAR);
