...
<%
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
    	...
    	if(act.equals("new")){    	    
    		...
    		if(Report_no.equals("A01") || Report_no.equals("A02") || Report_no.equals("A03") || Report_no.equals("A04") || Report_no.equals("A05") || Report_no.equals("A06") || Report_no.equals("A99") || Report_no.equals("A99_extra") || Report_no.equals("A08") || Report_no.equals("A09") || Report_no.equals("A10") || Report_no.equals("A10_extra") || Report_no.equals("A11_extra") || Report_no.equals("A12") || Report_no.equals("A12_extra") || Report_no.equals("A13") || Report_no.equals("A15")){ //95.11.20 add A06.A99 批次下載 by 2295 //96.07.11 add A08 //97.01.03 add A09 //97.06.13 add A10 //103.01.13 add A11_extra //104.01.21 add A12 //109.06.12 add A15				
    			//金融機構代號=============================================================
                ...
                if(Report_no.equals("A10_extra")){//97.06.19 add 中央存保格式A10檔案下載	    	       
    		       ...
    		       data = DBManager.QueryDB_SQLParam(sqlCmd.toString(),paramList,"m_year,m_month,amt,month_amt,year_amt"); 	 
    		    }   
