...
// 98.07.31 調整 牌告利率5日抓上個月份資料時,若有舊資料.先刪除 by 2295
//103.04.02 add 專案農貸明細資料/專案農貸貸款項目資料  by 2295
//103.05.19 add 金庫取檔使用sftp by 2295
//107.01.19 調整 金庫FTPServerIP調整為讀取設定檔(取消) by 2295
//108.01.30 add 增加25及28日轉檔(專案農貸資料皆為每月25及28日轉檔) by 2295
%>
 ...
 */
 ...
 /*
 //全國農業金庫主機
 String FTP_SERVER = Utility.getProperties("ftpIP_Agri");
 String FTP_USER = Utility.getProperties("ftpID_Agri");
 String FTP_PASSWORD =  Utility.getProperties("ftpIP_Agri");
 String FTP_DIRECTORY = "/out/";
 String LOCAL_DIRECTORY = "C:\\Sun\\WebServer6.1\\BOAF\\AgriBankData";
 */
 String alertMsg = "";	
 ...
 //15號傳ATM,CHK,FGN
 if(dday.equals("15") || dday.equals("25"))//108.01.31 add 增加25日轉檔
 {      
	for(int i=0;i<FileCount;i++){   	    
    	...
    	if(i==2){//96.01.10 調整 外國人存款資料.加上刪除wml01    	   
 ...
 //28號傳FRM
 if(dday.equals("28"))//108.01.31 add 增加28日轉檔[專案農貸資料]
 {      
	for(int i=0;i<FileCount;i++){   	    
	    sqlCmd = "select count(*) as countdata from ";
	    sqlCmd_delete=" delete ";
