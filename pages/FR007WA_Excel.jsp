...
<%
   ...
   String printStyle = ( request.getParameter("printStyle")==null ) ? "" : (String)request.getParameter("printStyle");//108.05.09 add  
   
   System.out.println("FR007WA:S_YEAR="+S_YEAR+":S_MONTH="+S_MONTH+":act="+act+":Unit="+Unit+":datestate="+datestate+":bank_type="+bank_type+":BANK_NO="+BANK_NO+":muser_id="+muser_id+":muser_name="+muser_name);
