...
<%
   ...
   */
    response.setHeader("Content-Disposition","attachment; filename=download."+printStyle);//108.05.07調整顯示的副檔名       
%>
<%
	try{	
	    ...
	    if(!printStyle.equalsIgnoreCase("xls")) {//108.05.07非xls檔須執行轉換	                
