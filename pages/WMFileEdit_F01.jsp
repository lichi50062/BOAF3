...
<%	
	...
	request.setAttribute("table_width","700");//111.03.18 fix
...
<table width="700" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
        ...
        <tr> 
          <td bgcolor="#FFFFFF">
			<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <td><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td><table width=700 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">                          
                          ...
                          <table width=700 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">                                                                              
                          <tr bgcolor='e7e7e7'>
              ...
              <tr>                  
                <td><div align="right"><jsp:include page="getMaintainUser.jsp?width=700" flush="true" /></div></td>              
              </tr>
              <tr> 
                <td>&nbsp;</td>
              </tr>
        ...
        <tr>
          <td bgcolor="#FFFFFF"><table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
              <tr> 
                <td><div align="center"><img src="images/line_1.gif" width="600" height="12"></div></td>
              </tr>
              <tr> 
                <td><table width="700" border="0" cellpadding="1" cellspacing="1" class="sbody">
                    <tr> 
