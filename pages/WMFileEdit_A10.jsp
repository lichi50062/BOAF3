...
//106.02.20 add 非授信資產可能遭受損失 by 2968
//111.03.18 調整table_width by 2295
%>
...
<%
	String YEAR  = Utility.getYear();
   	...
   	request.setAttribute("table_width","800");//111.03.18 fix
	...
	if(data_div01 != null && data_div01.size() != 0){	 		
		...
		baddebt_flag=Utility.getTrimString(bean.getValue("baddebt_flag"));//備呆等於或大於應提最低標準
  		...
  		property_loss=(bean.getValue("property_loss")==null ) ? "" : Utility.setCommaFormat((bean.getValue("property_loss")).toString());//非授信資產可能遭受損失
	}
...
<table width="746" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
  		<tr> 
                    ...
                    <tr> 
                      <td><Table width=<%=request.getAttribute("table_width") %> border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">
				        ...
				        <td width="210" bgcolor="#D8EFEE" height="49" rowspan="2">
                		   ...
                		   <tr class="sbody">
				        	<td width="625" bgcolor="#D8EFEE" height="26" colspan="5">
                    			<p align="center">非授信資產可能遭受損失(投資及其他資產)<font color="#FF0000">【註5】</font>
                    		</td>
                    		<td width="96" bgcolor="e7e7e7" height="25">
                            	<input type='text' name='property_loss' value="<%=Utility.setCommaFormat(property_loss)%>" size=16 maxlength=16 onFocus='this.value=changeVal(this)' onBlur='checkPoint_focus(this);this.value=changeStr(this);' style='text-align: right;'>
			                 </td>
                		   </tr>
                		   <tr class="sbody">
                ...
                <td><table width=<%=request.getAttribute("table_width") %> border="0" cellpadding="1" cellspacing="1" class="sbody">
                    ...
                    <tr> 
                      ...
                      <td width="729"> <ul>
						  ...
						  <li class="sbody" ><font color="#FF0000"><u>【註5】非授信資產可能遭受損失:</u></font></li>
						  <li class="sbody" ><font color="#FF0000"><u>1.法規:農漁會信用部應按資產(授信資產及非授信資產)之特性，評估其可能損失，並提足備抵呆帳及損失準備；前開評估之內部處理制度及程序應提經理事會通過後，報主管機關備查並副知全國農業金庫(農會漁會信用部資產評估損失準備提列及逾期放款催收款呆帳處理辦法第2條、第15條，及本會104年4月27日農授金字第1045070290號函釋)。</u></font></li>
						  <li class="sbody" ><font color="#FF0000"><u>2.請信用部按「非授信資產」特性評估其可能遭受損失。</u></font></li>
