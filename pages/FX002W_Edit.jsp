...
//106.03.07 add 通匯代號、業務項目、其他揭露事項 by 2968
//106.08.02 fix 總分支機構代號無法顯示問題 by 2295
...
<%
	...
	System.out.println("FX002W_Edit.tbank_no="+tbank_no);
	System.out.println("FX002W_Edit.bank_no="+bank_no);
	//94.04.06 
    ...
    //2018-05-09 Ethan.shih:add refer_date parse
	String REFER_DATE_Y="";
	String REFER_DATE_M="";
	String REFER_DATE_D="";
	String REFER_DATE="";
	...
	if(WLX02.size() != 0){
	    ...
	    //2018-05-09 Ethan.shih:add refer_date parse
		if(((DataObject)WLX02.get(0)).getValue("refer_date") != null){
			REFER_DATE = Utility.getCHTdate((((DataObject)WLX02.get(0)).getValue("refer_date")).toString().substring(0, 10), 0);
			tmpDate = Utility.getStringTokenizerData(REFER_DATE,"//");
			if(tmpDate != null && tmpDate.size() != 0){
				REFER_DATE_Y = (String)tmpDate.get(0);
				REFER_DATE_M = (String)tmpDate.get(1);
				REFER_DATE_D = (String)tmpDate.get(2);		      
			}
		}
		...
		if(((DataObject)WLX02.get(0)).getValue("trans_date") != null){//106.10.12 add		   
		   TRANS_DATE = Utility.getCHTdate((((DataObject)WLX02.get(0)).getValue("trans_date")).toString().substring(0, 10), 0);
		   System.out.println("TRANS_DATE="+TRANS_DATE);
		}
		if(((DataObject)WLX02.get(0)).getValue("online_date") != null){//106.11.23 add		   
		   ONLINE_DATE = Utility.getCHTdate((((DataObject)WLX02.get(0)).getValue("online_date")).toString().substring(0, 10), 0);
...
<input type='hidden' name='ori_bank_no' value="<%if(WLX02 != null && WLX02.size() != 0) out.print( (((DataObject)WLX02.get(0)).getValue("ori_bank_no")==null)?"": (String)((DataObject)WLX02.get(0)).getValue("ori_bank_no"));%>" >                            
                    ...
                    <tr> 
                      <td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">
						  ...
						  <td width='70%' colspan=2 bgcolor='e7e7e7'>  
						    ...
						    <%//94.11.14 fix 抓不到總機構代號tbank_no --> pbank_no by 2295%>
						    <input type='hidden' name='tbank_no' value="<%=tbank_no%>">     
						    <%=bank_no%>                     
                            <%//if(WLX02 != null && WLX02.size() != 0){
                                 //out.print((String)((DataObject)WLX02.get(0)).getValue("bank_no"));
                                 session.setAttribute("FX002W.bank_no",bank_no);
                              //}  
                            %>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;							
							<%if(!"".equals(ONLINE_DATE)){ 
							    ...
							    out.print("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");																	
							    out.print("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
								out.print((((DataObject)WLX02.get(0)).getValue("ori_bank_no")==null?"": "&nbsp;舊金融機構代號:"+(String)((DataObject)WLX02.get(0)).getValue("ori_bank_no")));
							  }	
							%>
                          </td>
                          </tr>
                          <tr class="sbody">
							<td width='30%' align='left' bgcolor='#D8EFEE'>分支機構通匯代號</td>
							<td width='70%' colspan=2 bgcolor='e7e7e7'>
	                            <input type='text' name='EXCHANGE_NO' value="<%if(WLX02 != null && WLX02.size() != 0) out.print( (((DataObject)WLX02.get(0)).getValue("exchange_no")==null)?"": (String)((DataObject)WLX02.get(0)).getValue("exchange_no"));%>" maxlength='7' >
	                        </td>
	                      </tr>
                          <tr class="sbody">
                        ...
                        <tr class="sbody">
	  					...
	  					<!-- 2018-05-10 Ethan.Shih: add operation -->
	  					<tr class="sbody">
							<td width='30%' align='left' bgcolor='#D8EFEE'>最近地方主管機關備查信用部分部主任函日期</td>
							<td width='70%' colspan=2 bgcolor='e7e7e7'>
								<input type='hidden' name='REFER_DATE' value="">
								<input type='text' name='REFER_DATE_Y' value="<%=REFER_DATE_Y%>" size='3' maxlength='3' onblur='CheckYear(this)'>
        						<font color='#000000'>年
	        						<select id="hide1" name=REFER_DATE_M>
		        						<option></option>
		        						<%for (int j = 1; j <= 12; j++){
		        							if (j < 10){%>        	
		        							<option value=0<%=j%> <%if(REFER_DATE_M.equals(String.valueOf("0"+j))) out.print("selected");%>>0<%=j%></option>        		
		            						<%}else{%>
		            						<option value=<%=j%> <%if(REFER_DATE_M.equals(String.valueOf(j))) out.print("selected");%>><%=j%></option>
		            						<%}%>
		        						<%}%>
	        						</select>
        						</font>
        						<font color='#000000'>月
	        						<select id="hide1" name=REFER_DATE_D>
	        						<option></option>
		        						<%for (int j = 1; j < 32; j++) {
		        							if (j < 10){%>        	
		        							<option value=0<%=j%> <%if(REFER_DATE_D.equals(String.valueOf("0"+j))) out.print("selected");%>>0<%=j%></option>        		
		            						<%}else{%>
		            						<option value=<%=j%> <%if(REFER_DATE_D.equals(String.valueOf(j))) out.print("selected");%>><%=j%></option>
		            						<%}%>
		        						<%}%>
	        						</select>
        						</font>
	  					...
	  					<tr class="sbody">
							<td width='30%' align='left' bgcolor='#D8EFEE'>最近地方主管機關備查信用部分部主任函文號</td>
							<td width='70%' colspan=2 bgcolor='e7e7e7'>
								<input type='text' name='REFER_NO' value="<%if(WLX02 != null && WLX02.size() != 0 && ((DataObject)WLX02.get(0)).getValue("refer_no") != null ) out.print((String)((DataObject)WLX02.get(0)).getValue("refer_no"));%>" size='50' maxlength='120' >
							</td>
	  					</tr>
	  					<tr class="sbody">
						<td width='30%' align='left' bgcolor='#D8EFEE'>業務項目</td>
						<td width='70%' colspan=2 bgcolor='e7e7e7'>
						<%
						String business_item=(((DataObject)WLX02.get(0)).getValue("business_item")==null)?"": (String)((DataObject)WLX02.get(0)).getValue("business_item");
                            	...
                            	for(int i=0;i<itemList.size();i++){ 
                            		...
                            		if(i<10){
                            			...
                            			if("99".equals((String)b.getValue("cmuse_id"))){
                            				String item_Extra = (((DataObject)WLX02.get(0)).getValue("business_item_extra")==null)?"": (String)((DataObject)WLX02.get(0)).getValue("business_item_extra");
                        ...
                        <tr class="sbody">
							<td width='30%' align='left' bgcolor='#D8EFEE'>其他揭露事項</td>
							<td width='70%' colspan=2 bgcolor='e7e7e7'>
								<textarea name='EXTRA_INFO' cols='50' rows='3' maxlength='200'><%if(WLX02 != null && WLX02.size() != 0) out.print( (((DataObject)WLX02.get(0)).getValue("extra_info")==null)?"": (String)((DataObject)WLX02.get(0)).getValue("extra_info"));%></textarea>
