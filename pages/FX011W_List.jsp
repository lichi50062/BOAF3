...
//109.02.26 fix 調整因查核結果顯示長度 by 2295
%>
...
<table width="1235" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td width="1235"><img src="images/space_1.gif" width="12" height="12"></td>
            </tr>
        <tr>
          <td bgcolor="#FFFFFF" width="815">
        
              <tr>
                <td width="1235" height="18">
                  <table width="1235" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="200"><img src="images/banner_bg1.gif" width="200" height="17" align="left"></td>
                      <td width="*" align="center"><b><font size="4">辦理農漁會信用部變現性資產查核</font></b></td>
              ...
              <tr>
              <td width="1235" height="50">
                <div align="left">
                <table width="1235" border="0"  cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="18" width="1235" >               
                      </td>
                    </tr>
                    <tr>                       
                    <div><jsp:include page="getLoginUser.jsp?width=1235" flush="true" /></div>			 							
			 		               
                    </tr>
                    <%if(permission != null && permission.get("A") != null && permission.get("A").equals("Y")){//Add %>
                    <tr>
                    <td width="1235" align="right" valign="bottom">
                    <table border="1" cellspacing="1" bordercolor="#3A9D99" width="1235"  class="sbody" cellpadding="0" height="20">
                      <tr>
                      <form name="date" method="post">                          				  		
                      <input type="hidden" name="prtStyle" value="">
                           <tr>
                           <td class="sbody" bgcolor="#E7E7E7" width="1235"  valign="middle" height="20">
						  	 執行情形報告表
                    ...
                    <%}%>
					 ...
					 <tr>
                      <td  align="center" width="1235" valign="top">
					  <table class="sbody" width="1235" border=1 cellpadding="0" cellspacing="1" bordercolor="#3A9D99" height="1" >
                         <tr bgcolor="#9AD3D0">                          
                          <td width="32" align="center" height="1">查核年度</td>
                          <td width="70" align="center" height="2">受檢單位</td>
                          <td width="70" align="center" height="2">查核日期</td>
                          <td width="100" align="center" height="2">查核人員</td>
                          <td width="180" align="center" height="2">查核項目</td>
                          <td width="460" align="center" height="2">查核結果</td>
                          <td width="270"  align="center" height="44">處理情形</td>
                          <td width="50"  align="center" height="44">備註</td>
                         </tr>
                          
                         <% if(BOAF_ASSETCHECK.size()==0){%>
                         <tr class="sbody" bgcolor="#D8EFEE"><td colspan="8" align="center"  height="19" width="1235" >
						 ...
						 <%}else{
                          ...
                          <tr class="sbody" bgcolor="<%out.print((i%2==0)?"#e7e7e7":"#D3EBE0");%>" width="1235">                           
                             <td class="sbody"  align=center height="38" width="32"><%=m_year%>&nbsp;</td>
                             <td class="sbody"  align=center height="19" width="70"><a href=FX011W.jsp?act=Edit&m_year=<%=m_year%>&tbank_no=<%=bank_no%>&examine=<%=examine%>><%=examine%><br><%=bank_name%></a>&nbsp;</td>
                             <td class="sbody"  align=center height="19" width="70"><%=check_date%>&nbsp;</td>
                             <td class="sbody"  align=center height="19" width="100"><%=name%></td>
                             <td class="sbody"  align=center height="19" width="180"><%=item%>&nbsp;</td>
                             <td class="sbody"  align=center height="19" width="460"><%=result%>&nbsp;</td>
                             <td class="sbody"  align=center height="16" width="270"><%=content%>&nbsp;</td>
                             <td class="sbody"  align=center height="16" width="50"><%=remark%>&nbsp;</td>                          
                          </tr>
                          <%  }//end of for 
                           }%>
					</table>                 
                    ...
                    <td width="1235" height="56"><div align="right"><div align="right">
                    <div align="center"><jsp:include page="getMaintainUser.jsp?width=1235" flush="true" /></div>
                    </div>
                    <p align="left">　</div></td>
      </table>
                </div>
  ...
  <tr>
                <td width="1235" height="123"><table width="591" border="0" cellpadding="1" cellspacing="1" class="sbody">
                    <tr>
