...
//106.11.28 fix 原AS003W更名為SumBn01 by 2295
%>
...
public String UpdateDB() throws Exception{    	
		...
		try {			    			    
	            ...
	            logfile = new File(logDir + System.getProperty("file.separator") + "AutoSumBn01."+ logfileformat.format(nowlog));						 
				System.out.println("logfile filename="+logDir + System.getProperty("file.separator") +"AutoSumBn01.log"+ logfileformat.format(nowlog));
