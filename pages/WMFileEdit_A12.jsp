...
function doPrint(form,fun,Report_no,S_YEAR,S_MONTH,bank_type) {		
	//108.05.10 add
	...
	//alert('prtStyle='+form.prtStyle.value);
	form.action="/pages/FR068W_Excel.jsp?bank_code="+form.bank_code.value+"&S_YEAR="+S_YEAR+"&S_MONTH="+S_MONTH+"&bank_type="+bank_type+"&printStyle="+form.prtStyle.value;
    form.submit();
}
                          ...
                          <tr class="sbody"> 
                            ...
                            <input type='text' name='S_YEAR' value="<%=S_YEAR%>" <%if(act.equals("Edit")) out.print("disabled");%> size='3' maxlength='3' onblur='CheckYear(this)'>
        						...
        						<%if(act.equals("Edit")){%>
                                    ...
                                    <a href="javascript:doPrint(this.document.forms[0],'Print','A12','<%=S_YEAR%>','<%=S_MONTH%>','');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image105','','images/bt_print.gif',1)"><img src="images/bt_print.gif" name="Image105" width="66" height="25" border="0" id="Image105"></a>                     
        						<%} %>
                            </td>
                          </tr>
