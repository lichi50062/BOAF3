<%
// 94.02.15 調整 若actMsg屬於檔案上傳成功時,則回到上傳時的那一個頁面 by 2295
// 94.10.31 調整 若actMsg在農漁會新增申報完成後，則顯示回到查詢頁 by 4180
// 94.11.15 add 回查詢頁所要link的jsp名稱 by 2295
// 95.01.17 調整 查詢頁所要link加bank_type by 2295
//107.06.11 調整 增加zz046w的回上一頁 by 6404
//107.06.11 調整 增加FX001W的找不到該檔案可提供下載,顯示關閉 by 6417
%>
...
<%
	...
	String ZZ = ( request.getParameter("zz")==null ) ? "" : (String)request.getParameter("zz");
...
<%}else if(actMsg.indexOf("找不到該檔案可提供下載")!= -1){ // 關閉視窗%>
<div><button onclick="window.close()" >關閉</button></div>
...
<%}else if(ZZ.indexOf("ZZ") != -1){ %>
<div><a href="/pages/<%=ZZ%>.jsp?act=List" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','images/bt_backb.gif',1)"><img src="images/bt_back.gif" name="Image8" width="80" height="25" border="0"></a></div>
<%}else{%>
