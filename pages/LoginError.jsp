...
//106.10.18 fix 恢復原動態顯示公告區 by 2295
//108.03.12 add 增加圖型驗證碼 by 2295
//109.02.27 fix 公告顯示顏色,增加部份關鍵字 by 2295
...
if(timeout.equals("true") || logout.equals("true")){    
   ...
   if(!batch_no.equals("") && !batch_no.equals("null")){//110.08.05 add
	   ...
	   String sqlCmd = "UPDATE WTT06 SET "				 
				    + " logout_time=sysdate" 	
  				    + " where serialno=? ";			   
 	   paramList.add(String.valueOf(batch_no)) ;//111.04.13 調整batchno寫入DB錯誤 by 2295	  		
 	   this.updDbUsesPreparedStatement(sqlCmd,paramList) ;      	
   }  
   session.invalidate();   			
}   
	...
	<tr colspan="0" bordercolor="#63B1AE" bgcolor="#408C87"><img src="images/hotnews.gif" width="70" height="18"></tr>	       
           ...
           <%
            ...
            for(int i=0;i<WLX_Notify.size();i++){
                ...
                if(headmark.indexOf("異常") != -1 || headmark.indexOf("設定") != -1 || headmark.indexOf("停止") != -1 || headmark.indexOf("暫停") != -1) fontColor="yellow";//關鍵字有異常.設定.停止.暫停時,以黃色顯示 109.02.27 fix
        ...
        <tr> 
          ...
          <td rowspan="2" valign="top" bgcolor="#78B5B3">
			<table width="250" border="0" align="center" cellpadding="0" cellspacing="1" class="sbody">
              ...
              <tr>
               <td width="65">驗證碼 :</td>
               <td width="182"><input type="text" name="kaptchafield"></td>              		
              </tr>  
              <tr>
                <td colspan="2">
                 <img id="codeImg" src="../randomcode.jpg" />
                </td>              		
              </tr>      
