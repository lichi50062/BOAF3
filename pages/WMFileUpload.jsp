...
//108.01.19 add 清空rptPwd,避免有memory dump的風險
//110.08.18 add A99.增加上傳.992451/992453/992455/992461/992463/992465銀行或企業名稱.長度最多160[111.06.13取消] by 2295
//111.08.25 add A02.增加上傳.991311/991321農金局文號.長度最多80 by 2295
%>
...
<%
	...
	System.out.println("Report_no="+Report_no+":WMdataDir="+WMdataDir+":WMTempBKDir="+WMTempBKDir);			
			...
			try{
				...
				while ((txtline = in.readLine()) != null) {
						if (txtline.trim().equals("")){
						    ...
						    //110.08.18 add A99.增加上傳.992451/992453/992455/992461/992463/992465銀行或企業名稱.長度最多160[111.06.13取消]
						    //111.08.25 add A02.增加上傳.991311/991321農金局文號.長度最多80
						    if ((!Report_no.equals("A05") && !Report_no.equals("A02") && byte1.length != rowlength) || 
						         ...
						         ((tmpBankCode.equals("990421") && byte1.length > 98) || 
						          ...
						          (tmpBankCode.equals("991311") && byte1.length > 98) ||    
						          (tmpBankCode.equals("991321") && byte1.length > 98) ||    
						          (!tmpBankCode.equals("990421") && !tmpBankCode.equals("990422") && !tmpBankCode.equals("990621") && !tmpBankCode.equals("990622") && !tmpBankCode.equals("991311") && !tmpBankCode.equals("991321") && byte1.length != rowlength))) 
						          /*|| [111.06.13取消]
						         (Report_no.equals("A99") && 
						         ((tmpBankCode.equals("992451") && byte1.length > 178) || 
						          (tmpBankCode.equals("992453") && byte1.length > 178) || 
						          (tmpBankCode.equals("992455") && byte1.length > 178) ||       
						          (tmpBankCode.equals("992461") && byte1.length > 178) ||       
						          (tmpBankCode.equals("992463") && byte1.length > 178) ||       
						          (tmpBankCode.equals("992465") && byte1.length > 178) ||       
						          (!tmpBankCode.equals("992451") && !tmpBankCode.equals("992453") && !tmpBankCode.equals("992455") && !tmpBankCode.equals("992461") && !tmpBankCode.equals("992463") && !tmpBankCode.equals("992465") && byte1.length != rowlength))) 
						          */ 
						       ) 
						    {		//modify by winnin 2004.12.23
								...
								for(int i=0;i<checkNumber.length;i++){		
									...
									// 110.08.18 add A99.992451/992453/992455/992461/992463/992465為名稱性欄位[111.06.13取消]
									// 111.08.25 add A02.991311/991321.為名稱性欄位									
									//System.out.println("tmpBankCode.substring(tmpBankCode.length()-1)="+tmpBankCodetmd.substring(tmpBankCode.length()-1));
									if(!tmpBankCode.substring(tmpBankCode.length()-1).equals("N") 
									&& !tmpBankCode.equals("990421") && !tmpBankCode.equals("990422") && !tmpBankCode.equals("990621") && !tmpBankCode.equals("990622") && !tmpBankCode.equals("991311") && !tmpBankCode.equals("991321") )
									//&& !tmpBankCode.equals("992451") && !tmpBankCode.equals("992453") && !tmpBankCode.equals("992455") && !tmpBankCode.equals("992461") && !tmpBankCode.equals("992463") && !tmpBankCode.equals("992465"))[111.06.13取消]
									{	//項目代號末一碼為N時或A02.990421/990621/990422/990622/991311/991321項目金額為文字性欄位
    ...
    private String uploadAcgfRpt(String report_no,String fileName){
        ...
        List updateDBSqlList = new LinkedList();
       	try{
		    ...
		    rptPwd = null;//108.01.19 add清空,避免有memory dump的風險
		    System.gc();
