...
//111.07.15 add 顯示A99的公式檢核錯誤 by 2295
%>
                ...
                <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <%
						...
						//111.07.15 add 顯示A99的公式檢核錯誤
						if (Report_no.equals("A01") || Report_no.equals("A02") || Report_no.equals("A04") || Report_no.equals("A05") || Report_no.equals("A13") || Report_no.equals("B01") || Report_no.equals("B05") || Report_no.equals("A99") ){
				      %>
