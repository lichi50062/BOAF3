...
//109.07.15 add A15 加申報年月 by 6493
%>
                    ...
                    <tr>
                      <td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">
                          <tr align=left bgcolor='#D2F0FF'>
                            ...
                            <%if(Report_no.equals("F01") || Report_no.equals("A06") || Report_no.equals("A99") || Report_no.equals("A08") || Report_no.equals("A10") || Report_no.equals("A15")){%>
                            ...
                            <%}%>
							<div align="left">&nbsp;
							<%if(Report_no.equals("F01") || Report_no.equals("A06") || Report_no.equals("A99") || Report_no.equals("A08") || Report_no.equals("A10") || Report_no.equals("A15")){//94.11.04 F01加申報年月//95.04.10 add A06加申報年月//95.05.25 add A99加申報年月 //97.06.13 add A10加申報年月//109.07.15 add A15加申報年月
