//111.3.17 設成IE顯示方式
//if (document.all)    {n=0;ie=1;fShow="visible";fHide="hidden";}//111.03.17
//if (document.layers) {n=1;ie=0;fShow="show";   fHide="hide";}//111.03.17
...
//		MENUitem += "style='text-decoration: none; font: "+this.menuFont+"; color: "+this.fontColor+"; cursor: hand;' ";
		...
		else
		{
			...
			//MENUitem += "onclick=\"hideAll();\" " //111.03.17 fix
...
function addSubItem(idParent, text, hint, location)
{
	...
	//if (ie) MENUitem = "<tr><td><a class=clsMenuItemIE title='"+hint+"' href='"+location+"' onclick=\"hideAll();\" >"+text+"</a><br></td></tr>\n";//111.03.17	
