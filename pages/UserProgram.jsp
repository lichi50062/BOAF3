...
<%
    ...
    if(dbData != null){
       System.out.println(muser_id+":dbData.size()="+dbData.size());
    }
%>
<html><head>
...
if( ( UpdateMuser_Data == null || !UpdateMuser_Data.equals("true")) && (dbData != null && dbData.size() != 0)){
   ...
   for(int i=0;i<dbData.size();i++){
       ...
       program_id=(String)bean.getValue("program_id");
       program_name=(String)bean.getValue("program_name");

       program_url=(String)bean.getValue("url_id");
       program_type_name=(String)bean.getValue("cmuse_name");
       //取得該program_id的權限==============================================================
       ...
       if(Program_Type.equals((String)bean.getValue("bank_type"))){
          if(permission != null && permission.get("Q") != null && permission.get("Q").equals("Y")){          	
          	
             if((!((String)bean.getValue("bank_type")).equals("Z"))
             &&  ( bank_type.equals("8")/*共用中心*/ || bank_type.equals("3")/*中央存保*/ || bank_type.equals("B")/*地方主管機關*/
                 ...
                 if(program_id.startsWith("DS") || program_id.startsWith("FR0066WB") || program_id.startsWith("RptFileUpload")  || program_id.startsWith("WMGenerateOperation") || program_id.startsWith("BR") || program_id.startsWith("FR") || program_id.startsWith("WR") || program_id.startsWith("BM")){
                   //95.11.09 DS決策支援分析系統直接進入內頁//95.11.27 FR0066WB直接進入內頁//98.08.12 RptFileUpload直接進入內頁//103.01.20 BR開頭接進入內頁 //105.03.14 FR開頭直接進入內頁
                      ...
                      program_url = program_url + "DS_bank_type="+(String)bean.getValue("bank_type");
                   }
                   //System.out.println("program_url="+program_url);                   
                     ...
                     program_url = "Bank_List.jsp?bank_type="+((String)bean.getValue("bank_type"))+"&link_name="+program_id;
                     //System.out.println("program_url="+program_url);
                 }
                 ...
                 if(program_id.equals("WMFileDownload") && (Program_Type.equals("8") || Program_Type.equals("B")) && !muser_type.equals("S")/*super user*/){
       		        program_url = "WMFileDownload.jsp?act=new&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }
       		     if(program_id.equals("WMFileEdit") && (Program_Type.equals("8") || Program_Type.equals("B")) && !muser_type.equals("S")/*super user*/){
       		        program_url = "WMFileEdit.jsp?act=List&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }
       		     if(program_id.equals("WMFileQuery") && (Program_Type.equals("8") || Program_Type.equals("B")) && !muser_type.equals("S")/*super user*/){
       		        program_url = "WMFileQuery.jsp?act=new&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }
       		     if(program_id.equals("WMFileUpload") && (Program_Type.equals("8") || Program_Type.equals("B")) && !muser_type.equals("S")/*super user*/){
       		        program_url = "WMFileUpload.jsp?act=new&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }
       		     ...
       		     && !muser_type.equals("S")/*super user*/){       		     
       		        program_url = "WMFileDownloadBatch_Qry.jsp?firstStatus=true&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }
       		     if(program_id.equals("WMFileDeleteBatch") && (Program_Type.equals("8") || Program_Type.equals("B")) && !muser_type.equals("S")/*super user*/){
       		        program_url = "WMFileDeleteBatch_Qry.jsp?firstStatus=true&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }
       		     ...
       		     if(program_id.equals("FX001W") && Program_Type.equals("B") && !bank_type.equals("2") && !muser_type.equals("S")/*super user*/){
       		        program_url = "FX001W.jsp?act=new&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }
       		     if(program_id.equals("FX002W") && Program_Type.equals("B") && !bank_type.equals("2") && !muser_type.equals("S")/*super user*/){
       		        program_url = "FX002W.jsp?act=List&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }
       		     if(program_id.equals("FX003W") && Program_Type.equals("B") && !bank_type.equals("2") && !muser_type.equals("S")/*super user*/){
       		        program_url = "FX003W.jsp?act=List&tbank_no="+tbank_no+"&bank_type="+((String)bean.getValue("bank_type"));
       		     }   
       		     //System.out.println("program_url="+program_url);    		    
             }else{
                 program_url = (program_url.indexOf("?") != -1)?program_url+"&":program_url+"?";
                 program_url = program_url + "bank_type="+(String)bean.getValue("bank_type");
             }
             ...
             if(program_id.equals("FX004W")){
                ...
                if(muser_type.equals("S") || (!((String)bean.getValue("bank_type")).equals(bank_type))){
      		       program_url = program_url+"&bank_type="+((String)bean.getValue("bank_type"));
      		    }else{
          ...
          Program_Type = (String)bean.getValue("bank_type");
   ...
   out.println("initializeDocument();");
   out.println("foldersTree.setState(0);");
   System.out.println(muser_id+":UserProgram end");
